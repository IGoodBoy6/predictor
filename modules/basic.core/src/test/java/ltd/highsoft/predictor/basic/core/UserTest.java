...
class UserTest {
    ...
    void should_create_a_user() {
        assertThat(new User(new Id(), new GlobalName(""), new Password("P@ssword"), new Name(""), new Email(""), Gender.MALE, new Text(""), new Url(""), new Organization(""), new Location(""))).isNotNull();
    }
