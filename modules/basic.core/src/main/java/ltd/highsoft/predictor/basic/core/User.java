...
public class User {
    ...
    public User(Id id, Name username, Name name, Email email, Optional<String> biography, Optional<String> url, Optional<String> organization, Optional<String> location) {
        this.id = id;
